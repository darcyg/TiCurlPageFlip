...
public class CurlActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mCurlView = (CurlView) findViewById(getResourceID("id.curl"));
	...
	private class PageProvider implements CurlView.PageProvider {
		...
		private int[] mBitmapIds = { 
				getResourceID("drawable.obama"), 
				getResourceID("drawable.road_rage"), 
				getResourceID("drawable.taipei_101"), 
				getResourceID("drawable.world") 
				};
		//private int[] mBitmapIds = { 0,1,2,3 };
